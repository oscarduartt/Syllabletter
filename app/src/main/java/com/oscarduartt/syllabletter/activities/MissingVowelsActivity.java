...
import com.oscarduartt.syllabletter.fragments.MissingVowelsActivityFragment;
import com.oscarduartt.syllabletter.objects.Game;

/**
 * Created by oilopez on 14/03/2016.
 */
public class MissingVowelsActivity extends BaseGameActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.game_container, new MissingVowelsActivityFragment().newInstance(true, 0)).commit();
        }
    }
}
